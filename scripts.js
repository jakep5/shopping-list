$("form :button").on("click", function(){
        ...
        $(".shopping-list").append([
            ...
            ("<div class='shopping-item-controls'><button class='shopping-item-toggle'><span class='button-label'>" + checkButton + "</span></button><button class='shopping-item-delete'><span class='button-label'>" + deleteButton + "</span></button></div></li>"),
        ]);
    });

//$("button.shopping-item-toggle").on("click", function(){
    //$(".shopping-item").attr(".shopping-item", ".shopping-item__checked");
//});
